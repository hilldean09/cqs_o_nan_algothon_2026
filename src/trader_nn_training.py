...
def runTrainingLoop( policy, number_Of_Episodes = 500, gamme = 0.99, lr = 1e-2 ):
...
if __name__ == "__main__":
    ...
    policy = onan.TraderNeuralNet().to( device )
    ...
    torch.save( trained_Policy.state_dict(), "./trader/trader_model_save_" + date_Time_String )
